...
public class HelpPlayGame {
  ...
  public static void display() {
    ...
    Text helpText4 = new Text("To the right,"
            + " you can see your goals. When finished a goal, they disappear.");
    helpText4.setFont(Font.font("Constantia"));
    Text helpText5 = new Text("When you finish your story or die,"
            + " a button will pop up to end the game.");
    helpText5.setFont(Font.font("Constantia"));
    Button closeButton = new Button(("Okay"));
    closeButton.setOnAction(e -> window.close());
    helpLayout.getChildren().addAll(helpTitle, helpText1,
            helpText2, helpText3, helpText4, helpText5, closeButton);
